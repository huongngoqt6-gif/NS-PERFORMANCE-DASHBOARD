    ...
    try:
        ...
        if page == "Overview":
            ...
            with c_chart1:
                ...
                fig1.update_layout(title="Actual HC vs Required HC",height=300, margin=dict(l=20, r=100, t=40, b=20), plot_bgcolor='rgba(0,0,0,0)')
            ...
            with c_chart2:
                ...
                fig2.update_layout(height=300,margin=dict(l=20, r=120, t=40, b=20), plot_bgcolor='rgba(0,0,0,0)')
